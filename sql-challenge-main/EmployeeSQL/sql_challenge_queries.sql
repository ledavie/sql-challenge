...
/*Question 4:
List the department number for each
employee along with that employee’s
...
of each employee whose first name is
Hercules and whose last name begins
with the letter B.*/
...
/*Question 6:
List each employee in the Sales
department, including their employee
...
their employee number, last name,
...
/*Question 8:
List the frequency counts, in
descending order, of all the employee
last names (that is, how many
